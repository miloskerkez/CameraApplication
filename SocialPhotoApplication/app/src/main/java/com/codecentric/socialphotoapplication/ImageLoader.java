...
public class ImageLoader extends Thread {
    public interface ImageLoadListener {
        void handleImageLoaded(ImageView aImageView, Bitmap aBitmap);
    }
     ...
     */
    public synchronized void queueImageLoad(final String aPath, final ImageView aImageView) {
        ...
        System.out.println("queueImageLoad");
    }
     ...
     */
    private void signalUI(ImageView aImageView,Bitmap aImage) {
        if (mListener != null) {
            // we have an object that implements ImageLoadListener
            mListener.handleImageLoaded(aImageView, aImage);
        }
    }
}
